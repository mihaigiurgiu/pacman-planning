...
class GameStateData:
    ...
    def __init__( self, prevState = None ):
        ...
        if prevState != None:
            ...
            self.holes = prevState.holes.shallowCopy()
            self.destination = prevState.destination.shallowCopy()
            self.restaurant = prevState.restaurant.shallowCopy()
    ...
    def deepCopy( self ):
        ...
        state.restaurant = self.restaurant.deepCopy()
        state.holes = self.holes.deepCopy()
        state.destination = self.destination.deepCopy()
    ...
    def initialize( self, layout, numGhostAgents ):
        ...
        self.layout = layout
        self.restaurant = layout.restaurant.copy()
        self.holes = layout.holes.copy()
        self.destination = layout.destination.copy()
        self.score = 0
        self.scoreChange = 0
